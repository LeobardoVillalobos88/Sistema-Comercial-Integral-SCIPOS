...
const CATALOGO_PRIVILEGIOS: Array<{ clave: string; descripcion: string }> = [
  ...
  { clave: "ventas:comprobante", descripcion: "Emitir el comprobante PDF no fiscal de una venta" },
  ...
  { clave: "reportes:utilidad", descripcion: "Consultar la utilidad y el margen del negocio" },
  { clave: "reportes:exportar", descripcion: "Descargar reportes en archivo CSV" },
